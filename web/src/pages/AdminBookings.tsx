...
import { adminListBookings, adminChargeBooking, adminUpdateBooking, ApiError } from '../lib/api'
...
function ChargeModal({
  ...
  const handleCharge = async () => {
    ...
    setError(null)
    try {
      const amount = customAmount ? Math.round(parseFloat(customAmount) * 100) : undefined
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full">
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Amount (leave blank for default rate × hours)
          </label>
